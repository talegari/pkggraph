...
vignette: >
  %\VignetteIndexEntry{Using pkggraph}
...
- The `nodeSize` argument might be 'in', 'out' or 'both'(default). The node size will depend on 'in' degree, 'out' degree or sum of them respectively.
- The `background` argument can be either `black` (Default) or `white`.
